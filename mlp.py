...
import numpy as np
import matplotlib
#matplotlib.use('Agg') # This allows the script to save images even without a screen
...
if torch.cuda.is_available():
    ...
    BATCH_SIZE = 512    # Optimized for your RTX 4060
    NUM_WORKERS = 0     # Keep at 0 for maximum stability on Windows
    PIN_MEMORY = True   
    print(f"🚀 Using GPU: {torch.cuda.get_device_name(0)}")
else:
    device = torch.device("cpu")
    BATCH_SIZE = 64     # Smaller for CPU to prevent freezing
    NUM_WORKERS = 0
    PIN_MEMORY = False
...
if __name__ == "__main__":
    ...
    if os.path.exists("best_mlp_model.pth"):
        ...
        print("No checkpoint found. Proceeding with current model.")
